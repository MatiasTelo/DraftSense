...
## Las 14 decisiones de arquitectura
...
| **006** pool escalonado | `champions.pool_tier` define 3 niveles: 1 núcleo (~40), 2 expansión (~80), 3 el resto. El sampler sólo usa los habilitados. **Promover un campeón es un `UPDATE`, no un despliegue.** El núcleo sale de un snapshot manual de pick rate versionado en `infra/seeds/` |
